...
if __name__ == "__main__":
  ...
  parser.add_argument("--port",
      type=int, default=defaultVRChatPort, help="The port vrchat will send osc data out of, normally 9001")
  ...
  dispatcher.map(contactAddress, vibration_handler, "headpat")
